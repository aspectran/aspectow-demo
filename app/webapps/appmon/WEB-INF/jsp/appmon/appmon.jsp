...
<link rel="stylesheet" href="<aspectran:url value="/assets/appmon/css/appmon.css?20250703c"/>">
<script src="<aspectran:url value="/assets/appmon/js/front-builder.js?20250703c"/>"></script>
<script src="<aspectran:url value="/assets/appmon/js/front-viewer.js?20250703"/>"></script>
<script src="<aspectran:url value="/assets/appmon/js/websocket-client.js?20250703"/>"></script>
