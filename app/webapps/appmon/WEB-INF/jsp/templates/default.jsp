...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<aspectran:token type='bean' expression='cdnAssets^url'/>/bootstrap@5.3.8/css/aspectran.css?v=20260224"/>
    ...
    <script src="https://cdn.jsdelivr.net/npm/dayjs@1.11.20/dayjs.min.js" integrity="sha256-nP25Pzivzy0Har7NZtMr/TODzfGWdlTrwmomYF2vQXM=" crossorigin="anonymous"></script>
    <script src="https://cdn.jsdelivr.net/npm/dayjs@1.11.20/plugin/utc.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/dayjs@1.11.20/plugin/localizedFormat.js"></script>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-md-7 col-lg-6 col-xl-5 d-flex">
                    ...
                    <div>
                        <a href="https://aspectran.com/aspectran/"><h5>About AppMon</h5></a>
                        <p><a href="https://aspectran.com/aspectran/">Aspectow AppMon is a lightweight, real-time monitoring solution for applications based on the Aspectran framework.</a></p>
                    </div>
                </div>
...
<script>
    $(function () {
        ...
        if (links.length > 0) {
            links.closest(".nav-item").addClass("active");
            let arr = [];
