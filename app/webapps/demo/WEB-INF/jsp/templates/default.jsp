    ...
    <div class="top-bar" id="gnb-menu" style="display:none">
        <div class="grid-container ${page.style}">
                ...
                <ul class="dropdown menu" data-dropdown-menu>
                    <li>
                        ...
                        <ul class="submenu menu vertical" data-submenu>
                            ...
                            <li><a href="<aspectran:url value="/examples/file-upload/"/>">File Upload</a></li>
                            <li><a href="<aspectran:url value="/chat/"/>">WebSocket Chat Demo</a></li>
                            <li><a href="<aspectran:url value="/interpreter/"/>">Remote Command Shell</a></li>
            ...
            <div class="top-bar-right">
                <ul class="dropdown menu" data-dropdown-menu>
                    <aspectran:profile expression="prod">
                        <li><a href="https://public.aspectran.com/appmon/front/#demo">Monitoring</a></li>
                    </aspectran:profile>
                    <aspectran:profile expression="!prod">
                        <li><a href="/appmon/front/#demo">Monitoring</a></li>
                    </aspectran:profile>
                    <li>
