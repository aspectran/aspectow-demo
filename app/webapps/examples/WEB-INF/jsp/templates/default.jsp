...
<head>
    ...
    <title>${empty page.title ? "Aspectran Examples" : page.title}</title>
    <meta name="description" content="${empty page.description ? "Welcome to the Aspectran Examples" : page.description}">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<aspectran:url value="/basics/hello-world"/>">Hello World</a></li>
                            <li><a class="dropdown-item" href="<aspectran:url value="/rest/gs-rest-service/"/>">RESTful Web Service</a></li>
                            <li><a class="dropdown-item" href="<aspectran:url value="/upload/file-upload/"/>">File Upload</a></li>
