	...
	<div id="RightSidebar">
		<div id="MyList">
			...
			<c:if test="${empty user.account}">
				<h4><a href="https://petclinic.aspectran.com">PetClinic Demo</a></h4>
				<a href="https://petclinic.aspectran.com"><img src="https://petclinic.aspectran.com/images/pets.png"/></a>
