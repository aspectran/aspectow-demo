            ...
            <ul class="nav d-none d-xl-flex">
                ...
                <li>
                    <aspectran:profile expression="prod">
                        <a class="nav-link px-2 text-warning" href="https://public.aspectran.com/monitoring/#jpetstore" target="_blank" title="Real-time logs, metrics, and traffic monitoring">AppMon</a>
                    </aspectran:profile>
                    <aspectran:profile expression="!prod">
