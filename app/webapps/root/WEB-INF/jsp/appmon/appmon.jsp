...
<script src="<aspectran:url value="/assets/js/appmon/appmon-builder.js?20241111"/>"></script>
<script src="<aspectran:url value="/assets/js/appmon/appmon-viewer.js?20241111"/>"></script>
<script src="<aspectran:url value="/assets/js/appmon/appmon-websocket-client.js?20241111"/>"></script>
<script src="<aspectran:url value="/assets/js/appmon/appmon-polling-client.js?20241111"/>"></script>
