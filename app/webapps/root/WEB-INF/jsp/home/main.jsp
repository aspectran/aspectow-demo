...
<div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4 pt-4">
    ...
    <div class="col">
        <div class="card h-100 shadow-sm">
            <a href="<aspectran:url value="/monitoring/"/>" title="View logs with AppMon"><img src="<aspectran:token type='bean' expression='cdnAssets^url'/>/screenshots/demo/aspectow-appmon.png" class="img-fluid"/></a>
            <div class="card-header">
                <a href="<aspectran:url value="/monitoring/"/>">Aspectow AppMon</a>
            </div>
            <div class="card-body">
                <p class="card-text">Aspectow AppMon is a lightweight, real-time application monitoring engine integrated into Aspectow Console, providing live metrics, request tracing, and log streaming.</p>
            </div>
        </div>
    </div>
</div>