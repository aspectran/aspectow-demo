...
<link rel="stylesheet" href="<aspectran:url value="/assets/css/monitoring/monitoring.css?20240729"/>">
<script src="<aspectran:url value="/assets/js/monitoring/appmon-builder.js?20240729"/>"></script>
<script src="<aspectran:url value="/assets/js/monitoring/appmon-viewer.js?20240729"/>"></script>
<script src="<aspectran:url value="/assets/js/monitoring/appmon-websocket-client.js?20240729"/>"></script>
<script src="<aspectran:url value="/assets/js/monitoring/appmon-polling-client.js?20240729"/>"></script>
