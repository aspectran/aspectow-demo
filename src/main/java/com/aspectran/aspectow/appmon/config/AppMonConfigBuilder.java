...
public abstract class AppMonConfigBuilder {
    ...
    private static final String APPMON_CONFIG_FILE = "com/aspectran/aspectow/appmon/appmon-config.apon";

    private static final String APPMON_CONFIG_FILE_PROD = "com/aspectran/aspectow/appmon/appmon-config-prod.apon";
